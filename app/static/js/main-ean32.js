...
function PressureGroup(metersInput, abt) {
    var result = 'X';
    var table1 = [
        [0, [35, 70, 110, 160, 225, 350]],
        [6.5, [35, 70, 110, 160, 225, 350]],
        [8, [25, 50, 75, 110, 135, 180, 240, 325]],
        [10, [20, 35, 55, 75, 100, 125, 160, 190, 245]],
        [12, [15, 30, 45, 60, 75, 95, 120, 145, 170, 205]],
        [13.5, [5, 15, 25, 40, 50, 60, 80, 100, 120, 140, 160]],
        [15, [5, 15, 25, 30, 40, 50, 70, 80, 100, 110, 130]],
        [18, [0, 10, 15, 25, 30, 40, 50, 60, 70]],
        [22, [0, 10, 15, 20, 25, 30, 40, 50]],
        [26, [0, 5, 10, 15, 20, 30, 35, 40]],
        [29, [0, 5, 10, 15, 20, 25, 30]],
        [32, [0, 5, 10, 12, 15, 20, 25]],
        [36, [0, 5, 7, 10, 15, 20]]
    ];
...
function GetResidualNitrogen(groupLetter, diveDepth, actualBottomTime) {
    var table3 = [
        [5, [39, 88, 159, 279]],
        [8, [18, 39, 62, 88, 120, 159, 208, 279, 399]],
        [12, [12, 25, 39, 54, 70, 88, 109, 132, 159, 190]],
        [15, [7, 17, 25, 37, 49, 61, 73, 87, 101, 116]],
        [18, [6, 13, 21, 29, 38, 47, 56, 66]],
        [22, [5, 11, 17, 24, 30, 36, 44]],
        [26, [4, 9, 15, 20, 26, 31, 37]],
        [29, [4, 8, 13, 18, 23, 28]],
        [32, [3, 7, 11, 16, 20, 24]],
        [36, [3, 7, 10, 14, 18]]
    ];
