...
function PressureGroup(metersInput, abt) {
    ...
    var table1 = [
        ...
        [7.5, [35, 70, 110, 160, 225, 350]],
        [9, [25, 50, 75, 110, 135, 180, 240, 325]],
        [11, [20, 35, 55, 75, 100, 125, 160, 190, 245]],
        [13, [15, 30, 45, 60, 75, 95, 120, 145, 170, 205]],
        [15, [5, 15, 25, 40, 50, 60, 80, 100, 120, 140, 160]],
        [17, [5, 15, 25, 30, 40, 50, 70, 80, 100, 110, 130]],
        [20, [0, 10, 15, 25, 30, 40, 50, 60, 70]],
        [24, [0, 10, 15, 20, 25, 30, 40, 50]],
        [28, [0, 5, 10, 15, 20, 30, 35, 40]],
...
function GetResidualNitrogen(groupLetter, diveDepth, actualBottomTime) {
    var table3 = [
        [6, [39, 88, 159, 279]],
        [9, [18, 39, 62, 88, 120, 159, 208, 279, 399]],
        [13, [12, 25, 39, 54, 70, 88, 109, 132, 159, 190]],
        [17, [7, 17, 25, 37, 49, 61, 73, 87, 101, 116]],
        [20, [6, 13, 21, 29, 38, 47, 56, 66]],
        [24, [5, 11, 17, 24, 30, 36, 44]],
        [28, [4, 9, 15, 20, 26, 31, 37]],
        [31, [4, 8, 13, 18, 23, 28]]
    ];
